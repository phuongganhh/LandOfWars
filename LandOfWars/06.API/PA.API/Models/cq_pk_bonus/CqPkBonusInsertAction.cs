...
namespace PA.API.Models.CqPkBonus
{
    public class CqPkBonusInsertAction : CommandBase
    {
        public cq_pk_bonus data { get; set; }
        ...
        {
            using(var cmd = new CqPkBonusInsertRepository())
			{
				cmd.data = this.data;
