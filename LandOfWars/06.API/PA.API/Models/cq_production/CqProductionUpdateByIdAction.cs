...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqProduction
{
    public class CqProductionUpdateByIdAction : CommandBase
    {
        public cq_production data { get; set; }
        ...
        {
            using(var cmd = new CqProductionUpdateByIdRepository())
			{
				cmd.data = this.data;
