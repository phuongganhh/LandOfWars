...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqTitle
{
    public class CqTitleUpdateByIdAction : CommandBase
    {
        public cq_title data { get; set; }
        ...
        {
            using(var cmd = new CqTitleUpdateByIdRepository())
			{
				cmd.data = this.data;
