...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqRobotUplevel
{
    public class CqRobotUplevelUpdateByIdAction : CommandBase
    {
        public cq_robot_uplevel data { get; set; }
        ...
        {
            using(var cmd = new CqRobotUplevelUpdateByIdRepository())
			{
				cmd.data = this.data;
