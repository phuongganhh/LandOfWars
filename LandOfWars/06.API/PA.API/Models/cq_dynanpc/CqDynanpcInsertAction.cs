...
namespace PA.API.Models.CqDynanpc
{
    public class CqDynanpcInsertAction : CommandBase
    {
        public cq_dynanpc data { get; set; }
        ...
        {
            using(var cmd = new CqDynanpcInsertRepository())
			{
				cmd.data = this.data;
