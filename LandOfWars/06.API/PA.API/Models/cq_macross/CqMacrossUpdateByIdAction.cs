...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMacross
{
    public class CqMacrossUpdateByIdAction : CommandBase
    {
        public cq_macross data { get; set; }
        ...
        {
            using(var cmd = new CqMacrossUpdateByIdRepository())
			{
				cmd.data = this.data;
