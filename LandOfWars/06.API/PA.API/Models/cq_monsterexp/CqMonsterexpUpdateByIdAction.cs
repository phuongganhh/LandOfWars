...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMonsterexp
{
    public class CqMonsterexpUpdateByIdAction : CommandBase
    {
        public cq_monsterexp data { get; set; }
        ...
        {
            using(var cmd = new CqMonsterexpUpdateByIdRepository())
			{
				cmd.data = this.data;
