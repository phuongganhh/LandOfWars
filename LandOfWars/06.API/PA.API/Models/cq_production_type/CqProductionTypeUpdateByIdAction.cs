...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqProductionType
{
    public class CqProductionTypeUpdateByIdAction : CommandBase
    {
        public cq_production_type data { get; set; }
        ...
        {
            using(var cmd = new CqProductionTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
