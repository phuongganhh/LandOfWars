...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAddresslist
{
    public class CqAddresslistUpdateByIdAction : CommandBase
    {
        public cq_addresslist data { get; set; }
        ...
        {
            using(var cmd = new CqAddresslistUpdateByIdRepository())
			{
				cmd.data = this.data;
