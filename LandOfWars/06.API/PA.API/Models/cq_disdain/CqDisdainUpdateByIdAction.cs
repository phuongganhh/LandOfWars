...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqDisdain
{
    public class CqDisdainUpdateByIdAction : CommandBase
    {
        public cq_disdain data { get; set; }
        ...
        {
            using(var cmd = new CqDisdainUpdateByIdRepository())
			{
				cmd.data = this.data;
