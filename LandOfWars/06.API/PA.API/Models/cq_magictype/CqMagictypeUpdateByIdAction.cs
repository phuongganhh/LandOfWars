...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMagictype
{
    public class CqMagictypeUpdateByIdAction : CommandBase
    {
        public cq_magictype data { get; set; }
        ...
        {
            using(var cmd = new CqMagictypeUpdateByIdRepository())
			{
				cmd.data = this.data;
