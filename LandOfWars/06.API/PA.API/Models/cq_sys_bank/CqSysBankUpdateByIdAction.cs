...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqSysBank
{
    public class CqSysBankUpdateByIdAction : CommandBase
    {
        public cq_sys_bank data { get; set; }
        ...
        {
            using(var cmd = new CqSysBankUpdateByIdRepository())
			{
				cmd.data = this.data;
