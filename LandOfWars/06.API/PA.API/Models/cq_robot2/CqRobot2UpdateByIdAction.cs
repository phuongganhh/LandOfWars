...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqRobot2
{
    public class CqRobot2UpdateByIdAction : CommandBase
    {
        public cq_robot2 data { get; set; }
        ...
        {
            using(var cmd = new CqRobot2UpdateByIdRepository())
			{
				cmd.data = this.data;
