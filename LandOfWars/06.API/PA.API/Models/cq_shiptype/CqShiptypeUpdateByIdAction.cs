...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqShiptype
{
    public class CqShiptypeUpdateByIdAction : CommandBase
    {
        public cq_shiptype data { get; set; }
        ...
        {
            using(var cmd = new CqShiptypeUpdateByIdRepository())
			{
				cmd.data = this.data;
