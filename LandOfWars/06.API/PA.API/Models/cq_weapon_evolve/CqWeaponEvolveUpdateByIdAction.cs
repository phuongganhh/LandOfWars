...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqWeaponEvolve
{
    public class CqWeaponEvolveUpdateByIdAction : CommandBase
    {
        public cq_weapon_evolve data { get; set; }
        ...
        {
            using(var cmd = new CqWeaponEvolveUpdateByIdRepository())
			{
				cmd.data = this.data;
