...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMonstertype
{
    public class CqMonstertypeUpdateByIdAction : CommandBase
    {
        public cq_monstertype data { get; set; }
        ...
        {
            using(var cmd = new CqMonstertypeUpdateByIdRepository())
			{
				cmd.data = this.data;
