...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqWeaponImprove
{
    public class CqWeaponImproveUpdateByIdAction : CommandBase
    {
        public cq_weapon_improve data { get; set; }
        ...
        {
            using(var cmd = new CqWeaponImproveUpdateByIdRepository())
			{
				cmd.data = this.data;
