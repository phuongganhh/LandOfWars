...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAdvertQueue
{
    public class CqAdvertQueueUpdateByIdAction : CommandBase
    {
        public cq_advert_queue data { get; set; }
        ...
        {
            using(var cmd = new CqAdvertQueueUpdateByIdRepository())
			{
				cmd.data = this.data;
