...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMonsterbook
{
    public class CqMonsterbookUpdateByIdAction : CommandBase
    {
        public cq_monsterbook data { get; set; }
        ...
        {
            using(var cmd = new CqMonsterbookUpdateByIdRepository())
			{
				cmd.data = this.data;
