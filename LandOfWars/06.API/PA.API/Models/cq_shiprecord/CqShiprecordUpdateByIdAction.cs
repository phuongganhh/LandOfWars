...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqShiprecord
{
    public class CqShiprecordUpdateByIdAction : CommandBase
    {
        public cq_shiprecord data { get; set; }
        ...
        {
            using(var cmd = new CqShiprecordUpdateByIdRepository())
			{
				cmd.data = this.data;
