...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqStatus
{
    public class CqStatusUpdateByIdAction : CommandBase
    {
        public cq_status data { get; set; }
        ...
        {
            using(var cmd = new CqStatusUpdateByIdRepository())
			{
				cmd.data = this.data;
