...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAnnounce
{
    public class CqAnnounceUpdateByIdAction : CommandBase
    {
        public cq_announce data { get; set; }
        ...
        {
            using(var cmd = new CqAnnounceUpdateByIdRepository())
			{
				cmd.data = this.data;
