...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqArtifactFunctionGrade
{
    public class CqArtifactFunctionGradeUpdateByIdAction : CommandBase
    {
        public cq_artifact_function_grade data { get; set; }
        ...
        {
            using(var cmd = new CqArtifactFunctionGradeUpdateByIdRepository())
			{
				cmd.data = this.data;
