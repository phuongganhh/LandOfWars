...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqTraptype
{
    public class CqTraptypeUpdateByIdAction : CommandBase
    {
        public cq_traptype data { get; set; }
        ...
        {
            using(var cmd = new CqTraptypeUpdateByIdRepository())
			{
				cmd.data = this.data;
