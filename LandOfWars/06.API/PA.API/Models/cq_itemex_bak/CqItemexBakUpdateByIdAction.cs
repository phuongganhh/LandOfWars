...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqItemexBak
{
    public class CqItemexBakUpdateByIdAction : CommandBase
    {
        public cq_itemex_bak data { get; set; }
        ...
        {
            using(var cmd = new CqItemexBakUpdateByIdRepository())
			{
				cmd.data = this.data;
