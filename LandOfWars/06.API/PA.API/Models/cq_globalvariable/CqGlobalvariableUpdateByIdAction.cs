...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqGlobalvariable
{
    public class CqGlobalvariableUpdateByIdAction : CommandBase
    {
        public cq_globalvariable data { get; set; }
        ...
        {
            using(var cmd = new CqGlobalvariableUpdateByIdRepository())
			{
				cmd.data = this.data;
