...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqEnemy
{
    public class CqEnemyUpdateByIdAction : CommandBase
    {
        public cq_enemy data { get; set; }
        ...
        {
            using(var cmd = new CqEnemyUpdateByIdRepository())
			{
				cmd.data = this.data;
