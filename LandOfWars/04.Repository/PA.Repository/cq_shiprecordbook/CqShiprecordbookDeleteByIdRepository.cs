...
{
    public class CqShiprecordbookDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_shiprecordbook").Where("cq_shiprecordbook.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
