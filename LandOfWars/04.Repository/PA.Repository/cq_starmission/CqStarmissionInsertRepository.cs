...
{
    public class CqStarmissionInsertRepository : CommandBase
    {
        public cq_starmission data { get; set; }
        ...
        {
            context.db.From("cq_starmission").Insert(this.data).ExecuteNotResult();
            return Success();
        }
