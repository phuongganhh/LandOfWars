...
{
    public class CqTutorAccessInsertRepository : CommandBase
    {
        public cq_tutor_access data { get; set; }
        ...
        {
            context.db.From("cq_tutor_access").Insert(this.data).ExecuteNotResult();
            return Success();
        }
