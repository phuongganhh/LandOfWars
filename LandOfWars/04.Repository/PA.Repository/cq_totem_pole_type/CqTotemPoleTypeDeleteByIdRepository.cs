...
{
    public class CqTotemPoleTypeDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_totem_pole_type").Where("cq_totem_pole_type.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
