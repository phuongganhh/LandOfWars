...
{
    public class CqEudemonExchgEggDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_eudemon_exchg_egg").Where("cq_eudemon_exchg_egg.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
