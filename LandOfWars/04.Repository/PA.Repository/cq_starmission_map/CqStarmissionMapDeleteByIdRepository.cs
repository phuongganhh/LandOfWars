...
{
    public class CqStarmissionMapDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_starmission_map").Where("cq_starmission_map.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
