...
{
    public class CqGlobalvariableDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_globalvariable").Where("cq_globalvariable.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
