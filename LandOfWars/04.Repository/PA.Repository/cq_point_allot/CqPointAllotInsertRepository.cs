...
{
    public class CqPointAllotInsertRepository : CommandBase
    {
        public cq_point_allot data { get; set; }
        ...
        {
            context.db.From("cq_point_allot").Insert(this.data).ExecuteNotResult();
            return Success();
        }
