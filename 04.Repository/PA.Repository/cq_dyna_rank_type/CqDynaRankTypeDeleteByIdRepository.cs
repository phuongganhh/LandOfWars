...
{
    public class CqDynaRankTypeDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_dyna_rank_type").Where("cq_dyna_rank_type.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
