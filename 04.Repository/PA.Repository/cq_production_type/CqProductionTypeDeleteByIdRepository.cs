...
{
    public class CqProductionTypeDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_production_type").Where("cq_production_type.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
