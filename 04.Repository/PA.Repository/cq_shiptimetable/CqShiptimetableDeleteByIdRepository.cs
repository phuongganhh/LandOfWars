...
{
    public class CqShiptimetableDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_shiptimetable").Where("cq_shiptimetable.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
