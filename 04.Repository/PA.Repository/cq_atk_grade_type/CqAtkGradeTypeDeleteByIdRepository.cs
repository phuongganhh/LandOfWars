...
{
    public class CqAtkGradeTypeDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_atk_grade_type").Where("cq_atk_grade_type.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
