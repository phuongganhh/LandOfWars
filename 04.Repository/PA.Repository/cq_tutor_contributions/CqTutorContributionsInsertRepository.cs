...
{
    public class CqTutorContributionsInsertRepository : CommandBase
    {
        public cq_tutor_contributions data { get; set; }
        ...
        {
            context.db.From("cq_tutor_contributions").Insert(this.data).ExecuteNotResult();
            return Success();
        }
