...
{
    public class CqSysShopPriceDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_sys_shop_price").Where("cq_sys_shop_price.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
