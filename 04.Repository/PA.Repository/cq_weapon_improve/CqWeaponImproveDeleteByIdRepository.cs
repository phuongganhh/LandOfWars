...
{
    public class CqWeaponImproveDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_weapon_improve").Where("cq_weapon_improve.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
