...
{
    public class CqEudemonExchgEggInsertRepository : CommandBase
    {
        public cq_eudemon_exchg_egg data { get; set; }
        ...
        {
            context.db.From("cq_eudemon_exchg_egg").Insert(this.data).ExecuteNotResult();
            return Success();
        }
