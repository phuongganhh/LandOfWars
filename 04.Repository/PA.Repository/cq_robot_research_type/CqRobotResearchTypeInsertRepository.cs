...
{
    public class CqRobotResearchTypeInsertRepository : CommandBase
    {
        public cq_robot_research_type data { get; set; }
        ...
        {
            context.db.From("cq_robot_research_type").Insert(this.data).ExecuteNotResult();
            return Success();
        }
