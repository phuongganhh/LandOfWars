...
{
    public class CqShipmissionInsertRepository : CommandBase
    {
        public cq_shipmission data { get; set; }
        ...
        {
            context.db.From("cq_shipmission").Insert(this.data).ExecuteNotResult();
            return Success();
        }
