...
{
    public class CqAmmoSkilltypeDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_ammo_skilltype").Where("cq_ammo_skilltype.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
