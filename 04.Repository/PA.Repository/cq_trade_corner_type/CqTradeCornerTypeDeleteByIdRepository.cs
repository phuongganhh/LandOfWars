...
{
    public class CqTradeCornerTypeDeleteByIdRepository : CommandBase
    {
        ...
        {
            context.db.From("cq_trade_corner_type").Where("cq_trade_corner_type.id",this.id).Delete().ExecuteNotResult();
            return Success();
        }
