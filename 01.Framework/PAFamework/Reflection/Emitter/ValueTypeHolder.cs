...
// 
// The latest version of this file can be found at http://PA.Framework.codeplex.com/
#endregion

using System;

namespace PA.Framework.Emitter
{
    /// <summary>
    /// A wrapper for value type.  Must be used in order for PA.Framework to 
    ...
    internal class ValueTypeHolder
    {
        ...
        /// can then be used with PA.Framework.
        /// </summary>
