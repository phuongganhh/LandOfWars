...
namespace ServerManager.TCP
{
    public class Server : IDisposable
    {
        public Server()
        {
            user = new Dictionary<string, PAFrame>();
        }
        ...
        private static Dictionary<string,PAFrame> user { get; set; }
        public void AddUser(PAFrame box)
        {
            user[box.client.GetIP()] = box;
            ThreadManager.Instance.Threads[box.thread.ManagedThreadId] = box.client;
        }
        public PAFrame GetUser(TcpClient e)
        {
