...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqPortal
{
    public class CqPortalUpdateByIdAction : CommandBase
    {
        public cq_portal data { get; set; }
        ...
        {
            using(var cmd = new CqPortalUpdateByIdRepository())
			{
				cmd.data = this.data;
