...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqDeluser
{
    public class CqDeluserUpdateByIdAction : CommandBase
    {
        public cq_deluser data { get; set; }
        ...
        {
            using(var cmd = new CqDeluserUpdateByIdRepository())
			{
				cmd.data = this.data;
