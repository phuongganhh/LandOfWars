...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqDynaRankType
{
    public class CqDynaRankTypeUpdateByIdAction : CommandBase
    {
        public cq_dyna_rank_type data { get; set; }
        ...
        {
            using(var cmd = new CqDynaRankTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
