...
namespace PA.API.Models.CqModuleStar
{
    public class CqModuleStarInsertAction : CommandBase
    {
        public cq_module_star data { get; set; }
        ...
        {
            using(var cmd = new CqModuleStarInsertRepository())
			{
				cmd.data = this.data;
