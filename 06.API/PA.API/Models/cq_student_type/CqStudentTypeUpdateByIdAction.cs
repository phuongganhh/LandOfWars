...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqStudentType
{
    public class CqStudentTypeUpdateByIdAction : CommandBase
    {
        public cq_student_type data { get; set; }
        ...
        {
            using(var cmd = new CqStudentTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
