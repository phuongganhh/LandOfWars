...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqResearch
{
    public class CqResearchUpdateByIdAction : CommandBase
    {
        public cq_research data { get; set; }
        ...
        {
            using(var cmd = new CqResearchUpdateByIdRepository())
			{
				cmd.data = this.data;
