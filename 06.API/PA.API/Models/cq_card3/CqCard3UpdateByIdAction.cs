...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqCard3
{
    public class CqCard3UpdateByIdAction : CommandBase
    {
        public cq_card3 data { get; set; }
        ...
        {
            using(var cmd = new CqCard3UpdateByIdRepository())
			{
				cmd.data = this.data;
