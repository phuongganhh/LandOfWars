...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMessage
{
    public class CqMessageUpdateByIdAction : CommandBase
    {
        public cq_message data { get; set; }
        ...
        {
            using(var cmd = new CqMessageUpdateByIdRepository())
			{
				cmd.data = this.data;
