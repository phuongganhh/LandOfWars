...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAcademebuild
{
    public class CqAcademebuildUpdateByIdAction : CommandBase
    {
        public cq_academebuild data { get; set; }
        ...
        {
            using(var cmd = new CqAcademebuildUpdateByIdRepository())
			{
				cmd.data = this.data;
