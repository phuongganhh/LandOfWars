...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqForgeGem
{
    public class CqForgeGemUpdateByIdAction : CommandBase
    {
        public cq_forge_gem data { get; set; }
        ...
        {
            using(var cmd = new CqForgeGemUpdateByIdRepository())
			{
				cmd.data = this.data;
