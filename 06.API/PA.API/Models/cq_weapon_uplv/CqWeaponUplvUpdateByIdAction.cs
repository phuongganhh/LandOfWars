...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqWeaponUplv
{
    public class CqWeaponUplvUpdateByIdAction : CommandBase
    {
        public cq_weapon_uplv data { get; set; }
        ...
        {
            using(var cmd = new CqWeaponUplvUpdateByIdRepository())
			{
				cmd.data = this.data;
