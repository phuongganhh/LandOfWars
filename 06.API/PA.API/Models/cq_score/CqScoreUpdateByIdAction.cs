...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqScore
{
    public class CqScoreUpdateByIdAction : CommandBase
    {
        public cq_score data { get; set; }
        ...
        {
            using(var cmd = new CqScoreUpdateByIdRepository())
			{
				cmd.data = this.data;
