...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqSysMessage
{
    public class CqSysMessageUpdateByIdAction : CommandBase
    {
        public cq_sys_message data { get; set; }
        ...
        {
            using(var cmd = new CqSysMessageUpdateByIdRepository())
			{
				cmd.data = this.data;
