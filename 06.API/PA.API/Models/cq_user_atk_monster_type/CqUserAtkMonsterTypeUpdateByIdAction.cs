...
{
    public class CqUserAtkMonsterTypeUpdateByIdAction : CommandBase
    {
        public cq_user_atk_monster_type data { get; set; }
        ...
        {
            using(var cmd = new CqUserAtkMonsterTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
