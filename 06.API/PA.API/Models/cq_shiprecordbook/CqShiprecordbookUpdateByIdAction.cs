...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqShiprecordbook
{
    public class CqShiprecordbookUpdateByIdAction : CommandBase
    {
        public cq_shiprecordbook data { get; set; }
        ...
        {
            using(var cmd = new CqShiprecordbookUpdateByIdRepository())
			{
				cmd.data = this.data;
