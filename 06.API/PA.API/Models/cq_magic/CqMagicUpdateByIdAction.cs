...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqMagic
{
    public class CqMagicUpdateByIdAction : CommandBase
    {
        public cq_magic data { get; set; }
        ...
        {
            using(var cmd = new CqMagicUpdateByIdRepository())
			{
				cmd.data = this.data;
