...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAmmoSkill
{
    public class CqAmmoSkillUpdateByIdAction : CommandBase
    {
        public cq_ammo_skill data { get; set; }
        ...
        {
            using(var cmd = new CqAmmoSkillUpdateByIdRepository())
			{
				cmd.data = this.data;
