...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqContracttype
{
    public class CqContracttypeUpdateByIdAction : CommandBase
    {
        public cq_contracttype data { get; set; }
        ...
        {
            using(var cmd = new CqContracttypeUpdateByIdRepository())
			{
				cmd.data = this.data;
