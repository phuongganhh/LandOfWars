...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqSynwarCfg
{
    public class CqSynwarCfgUpdateByIdAction : CommandBase
    {
        public cq_synwar_cfg data { get; set; }
        ...
        {
            using(var cmd = new CqSynwarCfgUpdateByIdRepository())
			{
				cmd.data = this.data;
