...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqShiptimetable
{
    public class CqShiptimetableUpdateByIdAction : CommandBase
    {
        public cq_shiptimetable data { get; set; }
        ...
        {
            using(var cmd = new CqShiptimetableUpdateByIdRepository())
			{
				cmd.data = this.data;
