...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqRebirth
{
    public class CqRebirthUpdateByIdAction : CommandBase
    {
        public cq_rebirth data { get; set; }
        ...
        {
            using(var cmd = new CqRebirthUpdateByIdRepository())
			{
				cmd.data = this.data;
