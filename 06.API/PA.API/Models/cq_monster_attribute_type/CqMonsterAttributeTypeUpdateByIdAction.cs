...
{
    public class CqMonsterAttributeTypeUpdateByIdAction : CommandBase
    {
        public cq_monster_attribute_type data { get; set; }
        ...
        {
            using(var cmd = new CqMonsterAttributeTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
