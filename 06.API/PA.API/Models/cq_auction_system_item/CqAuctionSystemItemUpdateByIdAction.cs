...
{
    public class CqAuctionSystemItemUpdateByIdAction : CommandBase
    {
        public cq_auction_system_item data { get; set; }
        ...
        {
            using(var cmd = new CqAuctionSystemItemUpdateByIdRepository())
			{
				cmd.data = this.data;
