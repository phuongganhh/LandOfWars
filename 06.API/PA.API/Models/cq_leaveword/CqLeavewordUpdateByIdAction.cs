...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqLeaveword
{
    public class CqLeavewordUpdateByIdAction : CommandBase
    {
        public cq_leaveword data { get; set; }
        ...
        {
            using(var cmd = new CqLeavewordUpdateByIdRepository())
			{
				cmd.data = this.data;
