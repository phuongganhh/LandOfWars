...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqStarmissionMap
{
    public class CqStarmissionMapUpdateByIdAction : CommandBase
    {
        public cq_starmission_map data { get; set; }
        ...
        {
            using(var cmd = new CqStarmissionMapUpdateByIdRepository())
			{
				cmd.data = this.data;
