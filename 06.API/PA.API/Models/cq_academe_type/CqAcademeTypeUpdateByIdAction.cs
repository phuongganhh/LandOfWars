...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAcademeType
{
    public class CqAcademeTypeUpdateByIdAction : CommandBase
    {
        public cq_academe_type data { get; set; }
        ...
        {
            using(var cmd = new CqAcademeTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
