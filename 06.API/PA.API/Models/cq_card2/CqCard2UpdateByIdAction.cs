...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqCard2
{
    public class CqCard2UpdateByIdAction : CommandBase
    {
        public cq_card2 data { get; set; }
        ...
        {
            using(var cmd = new CqCard2UpdateByIdRepository())
			{
				cmd.data = this.data;
