...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqPathset
{
    public class CqPathsetUpdateByIdAction : CommandBase
    {
        public cq_pathset data { get; set; }
        ...
        {
            using(var cmd = new CqPathsetUpdateByIdRepository())
			{
				cmd.data = this.data;
