...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqShippath
{
    public class CqShippathUpdateByIdAction : CommandBase
    {
        public cq_shippath data { get; set; }
        ...
        {
            using(var cmd = new CqShippathUpdateByIdRepository())
			{
				cmd.data = this.data;
