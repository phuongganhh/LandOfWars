...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqDynamap
{
    public class CqDynamapUpdateByIdAction : CommandBase
    {
        public cq_dynamap data { get; set; }
        ...
        {
            using(var cmd = new CqDynamapUpdateByIdRepository())
			{
				cmd.data = this.data;
