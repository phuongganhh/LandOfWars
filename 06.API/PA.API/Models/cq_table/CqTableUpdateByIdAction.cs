...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqTable
{
    public class CqTableUpdateByIdAction : CommandBase
    {
        public cq_table data { get; set; }
        ...
        {
            using(var cmd = new CqTableUpdateByIdRepository())
			{
				cmd.data = this.data;
