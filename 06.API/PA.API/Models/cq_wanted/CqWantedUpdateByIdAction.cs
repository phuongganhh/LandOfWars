...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqWanted
{
    public class CqWantedUpdateByIdAction : CommandBase
    {
        public cq_wanted data { get; set; }
        ...
        {
            using(var cmd = new CqWantedUpdateByIdRepository())
			{
				cmd.data = this.data;
