...
{
    public class CqTutorBattleLimitTypeUpdateByIdAction : CommandBase
    {
        public cq_tutor_battle_limit_type data { get; set; }
        ...
        {
            using(var cmd = new CqTutorBattleLimitTypeUpdateByIdRepository())
			{
				cmd.data = this.data;
