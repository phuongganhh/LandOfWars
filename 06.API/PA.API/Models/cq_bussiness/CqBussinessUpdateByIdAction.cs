...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqBussiness
{
    public class CqBussinessUpdateByIdAction : CommandBase
    {
        public cq_bussiness data { get; set; }
        ...
        {
            using(var cmd = new CqBussinessUpdateByIdRepository())
			{
				cmd.data = this.data;
