...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqSuperman
{
    public class CqSupermanUpdateByIdAction : CommandBase
    {
        public cq_superman data { get; set; }
        ...
        {
            using(var cmd = new CqSupermanUpdateByIdRepository())
			{
				cmd.data = this.data;
