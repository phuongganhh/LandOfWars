...
using System.Web;
using PA.Repository;
namespace PA.API.Models.CqAction
{
    public class CqActionUpdateByIdAction : CommandBase
    {
        public cq_action data { get; set; }
        ...
        {
            using(var cmd = new CqActionUpdateByIdRepository())
			{
				cmd.data = this.data;
