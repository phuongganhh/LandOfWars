...
{
    public class CqRobotTechnopointUpdateByIdAction : CommandBase
    {
        public cq_robot_technopoint data { get; set; }
        ...
        {
            using(var cmd = new CqRobotTechnopointUpdateByIdRepository())
			{
				cmd.data = this.data;
